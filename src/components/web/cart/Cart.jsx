...
export default function Cart() {
  ...
  const {getCartContext,removeItemContext,clearCartContext,increaseQty,decreaseQty} = useContext(CartContext);
  const getCart =async ()=>{
      ...
      <div className="container">
        <div className="row">
          <div className="cart-items">
            <div className="products" id="products">
              ...
              {cart?.products?(
                ...
                <div className="quantity">
                  <button onClick={() => decreaseQty(product.productId)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={17}
                  ...
                  <button onClick={() => increaseQty(product.productId)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={17}
          ...
          <div>
            ...
            {data?.products?(
              <button type="button" className="btn btn-danger btn-lg btn-block" onClick={()=>clearCart(products)}>clear Cart</button>
            ):<h2>cart is empty</h2> }
